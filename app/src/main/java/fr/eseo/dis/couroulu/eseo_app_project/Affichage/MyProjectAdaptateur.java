...
public class MyProjectAdaptateur extends ArrayAdapter<Project> {

    public MyProjectAdaptateur(Context context, List<Project> projects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_my_project,parent, false);
        }

        MyProjectAdaptateur.ProjectViewHolder viewHolder = (MyProjectAdaptateur.ProjectViewHolder) convertView.getTag();
        if(viewHolder == null){
            viewHolder = new MyProjectAdaptateur.ProjectViewHolder();
